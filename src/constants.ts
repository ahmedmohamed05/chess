...
INIT_POSITION.set(coordinateToKey({ rank: 2, file: 2 }), {
  type: "king",
  color: "dark",
  coordinates: { rank: 2, file: 2 },
});

INIT_POSITION.set(coordinateToKey({ rank: 7, file: 1 }), {
  type: "pawn",
  color: "light",
  hasMoved: true,
  coordinates: { rank: 7, file: 1 },
});
INIT_POSITION.set(coordinateToKey({ rank: 6, file: 1 }), {
  type: "king",
  color: "light",
  hasMoved: true,
  coordinates: { rank: 6, file: 1 },
});

INIT_POSITION.set(coordinateToKey({ rank: 4, file: 1 }), {
  type: "rook",
  color: "light",
  hasMoved: true,
  coordinates: { rank: 4, file: 1 },
});
