...
INIT_POSITION.set(coordinateToKey({ rank: 2, file: 1 }), {
  color: "light",
  coordinates: { rank: 2, file: 1 },
  type: "king",
});
...
INIT_POSITION.set(coordinateToKey({ rank: 8, file: 4 }), {
  color: "dark",
  coordinates: { rank: 8, file: 4 },
  type: "pawn",
});

INIT_POSITION.set(coordinateToKey({ rank: 7, file: 4 }), {
  color: "dark",
  coordinates: { rank: 7, file: 4 },
  type: "pawn",
});

INIT_POSITION.set(coordinateToKey({ rank: 7, file: 5 }), {
  color: "dark",
  coordinates: { rank: 7, file: 5 },
  type: "pawn",
});
INIT_POSITION.set(coordinateToKey({ rank: 7, file: 6 }), {
  color: "dark",
  coordinates: { rank: 7, file: 6 },
  type: "pawn",
});

INIT_POSITION.set(coordinateToKey({ rank: 6, file: 6 }), {
  color: "dark",
  coordinates: { rank: 6, file: 6 },
  type: "knight",
});

INIT_POSITION.set(coordinateToKey({ rank: 6, file: 8 }), {
  color: "light",
  coordinates: { rank: 6, file: 8 },
  type: "queen",
});
